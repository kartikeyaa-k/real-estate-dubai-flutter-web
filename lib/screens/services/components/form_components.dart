...
class FormComponents {
        ...
        Column(
          children: _toolBarSwitchCondition
              ? [
                  ...
                  BannerImage(
                    imageLocation: 'assets/service/service_provider_banner.png',
                  )
                ]
              : [],
        ),
        Align(
          ...
          child: Column(
            ...
            children: [
              ...
              _vSpace,
              _vSpace,
              Text("Service Provider Registration", style: TS.headerWhite),
              // _vSpace,
              // SizedBox(
              //   width: wp(40),
              //   child: Text(
  ...
  static leftFormStatusDisplay(BuildContext context, int _formIndex) {
    ...
    switch (_formIndex) {
      case 0:
        return Container(
          width: Responsive.isDesktop(context) ? wp(20) : 110,

        ...
        if (_toolBarSwitchCondition)
          Positioned(
            ...
            child: Container(
              height: 80,
              decoration:
                  BoxDecoration(color: Colors.white, borderRadius: Corners.lgBorder, boxShadow: Shadows.universal),
              padding: EdgeInsets.symmetric(horizontal: Insets.lg),
              child: Row(
                children: [
                  Text("Community Guidelines", style: TextStyles.h3.copyWith(color: kBlackVariant)),
                  Spacer(flex: 4),
                  Flexible(
                    flex: 4,
                    child: Align(

...
class ProjectDetailSecondaryDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _details = [
      _propertyDetailRow(title: "Price From:", value: "AED $startingPrice"),
    ...
    Widget _propertyDetailTitle =
        Text("Property Detail:", style: TextStyles.h2.copyWith(color: kBlackVariant), key: globalKey);
    ...
    List<Widget> _amenities = [
      ...
      _vSpace,
      Wrap(children: amenities.map((e) => _amenitiesRow(title: e.name.en)).toList()),
    ];
    ...
    List<Widget> _additionalFeatures = [
      ...
      _vSpace,
      Wrap(children: additionalFeatures.map((e) => _amenitiesRow(title: e.name.en)).toList()),
    ];
    ...
    List<Widget> _mapView = [
      ...
      // map view
      AspectRatio(
        aspectRatio: Responsive.isDesktop(context) ? 710 / 400 : 794 / 250,
        child: Stack(
          children: [
            GoogleMap(

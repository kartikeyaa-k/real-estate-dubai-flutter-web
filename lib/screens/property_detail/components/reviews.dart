...
class PropertyDetailReviews extends StatelessWidget {
  const PropertyDetailReviews({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _addRating("Location", 0),
              _addRating("Security", 0),
              _addRating("Maintenance", 0),
              _addRating("Amenities", 0),
            ],
          )
        ],
      ),
    ...
    Widget _reviews = Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(child: Text("No Review yet!", style: TextStyles.h4))
          // Comment item
          // ListView.builder(
          //   primary: false,
          //   shrinkWrap: true,
            ...
            Row(
              ...
              children: [
                ...
                Container(
                    ...
                    height: !Responsive.isDesktop(context) ? 20 : null),

      ...
      CustomIconButton(
        ...
        onTap: () {
          Share.share(
            ...
            subject: 'Search For Your Dream Property',
          );
        },
      ),
    ],
        ...
        children: [
          ...
          Positioned(
            ...
            child: Wrap(
              ...
              spacing: 10,
              children: [
                if (isVerified ?? false) TextTagButton(text: "Verified", backgroundColor: kSupportGreen),
      ...
      children: [
        ...
        Flexible(
          child: Container(
            ...
            child: Text(
              (location == null) ? "Soon" : location.toString(),
              style: textStyle ??
      ...
      children: [
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Text(
                price != null ? "\AED $price" : "TBD",
                style: TextStyles.h4.copyWith(color: kBlackVariant),
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
              // SizedBox(height: 5),
